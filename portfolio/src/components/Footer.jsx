    ...
    <footer className="bg-gray-900 text-white py-8 mt-20">
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex flex-col md:flex-row items-center gap-4">
          <span className="font-bold text-lg">Daniel Mailu</span>
        ...
        <div className="flex gap-4">
          <a href="https://github.com/Daninc24" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="hover:text-blue-400 transition">
          ...
          <a href="https://www.linkedin.com/in/daniel-ngila-445b6b187/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-blue-400 transition">
          ...
          <a href="https://twitter.com/danielmailu" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="hover:text-blue-400 transition">
        ...
        <div className="text-gray-400 text-xs mt-4 md:mt-0">&copy; {new Date().getFullYear()} Daniel Mailu Ngila. All rights reserved.</div>
      </div>
    </footer>
  );
};
