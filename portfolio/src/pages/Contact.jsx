          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="bg-gradient-to-br from-cyan-600 to-red-600 rounded-2xl p-6 md:p-8 text-white hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <a
                ...
                className="inline-flex items-center bg-white bg-opacity-20 text-black font-bold px-6 py-3 rounded-lg hover:bg-opacity-30 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-600 mt-4"
